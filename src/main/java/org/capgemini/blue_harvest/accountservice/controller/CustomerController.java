...
public class CustomerController {
    ...
    public ResponseEntity<ResponseTemplate> getAllCustomers() {
		...
		ResponseEntity<ResponseTemplate> responseEntity = new ResponseEntity<>(new ResponseTemplate(AccountConstant.CUSTOMERS_FETCH_SUCCESS_MESSAGE, HttpStatus.OK.value(), customerService.getAllCustomers()), HttpStatus.OK);
