...
public class AccountController {
    ...
    public ResponseEntity<ResponseTemplate> openCurrentAccount(@RequestBody AccountRequest accountRequest) {
        ...
        ResponseEntity<ResponseTemplate> responseEntity = new ResponseEntity<>(
                new ResponseTemplate(
                        AccountConstant.ACCOUNT_OPEN_SUCCESS_MESSAGE,
    ...
    public ResponseEntity<ResponseTemplate> getCustomerAccounts(@RequestParam(APIConstants.REQUEST_PARAM_CUSTOMER_ID) Long customerId) {
        ...
        ResponseEntity<ResponseTemplate> responseEntity = new ResponseEntity<>(
                ...
                HttpStatus.OK);
        logger.info(AccountConstant.ACCOUNT_FETCH_SUCCESS_LOGGER + customerId + ": " + accounts.size());
        return responseEntity;
    }
}
